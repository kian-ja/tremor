...
for i = 1 : 7
    ...
    EMG_TA_DF = concatenateEMGTAMultipleTrials(experiment.fileName{i},experiment.DF.Trials{i});
    Results.DF.EMG_TA_RMS{i} = rms(EMG_TA_DF);
    ...
    EMG_TA_PF1 = concatenateEMGTAMultipleTrials(experiment.fileName{i},experiment.PF1.Trials{i});
    Results.PF1.EMG_TA_RMS{i} = rms(EMG_TA_PF1);
    ...
    EMG_TA_PF2 = concatenateEMGTAMultipleTrials(experiment.fileName{i},experiment.PF2.Trials{i});
    Results.PF2.EMG_TA_RMS{i} = rms(EMG_TA_PF2);
